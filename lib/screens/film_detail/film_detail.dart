        ...
        body: FutureBuilder(
          ...
          builder: (ctx, snapshot) {
            ...
            if (_film.reviews.isNotEmpty) {
              voteAverage = _film.reviews.fold(0,
                      (previousValue, review) => previousValue + review.star) /
                                  ...
                                  return PopupMenuButton(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          Text(
                                            _film.seasons[_currentSeasonIndex]
                                                .name,
                                            style: const TextStyle(
                                              color: Colors.white,
                                              fontSize: 18,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        BottomTab(
                          filmId: _film.id,
                          isMovie: _isMovie,
                          episodes: _film.seasons[_currentSeasonIndex].episodes,
                        ),
                        const Gap(20),
                      ],
                    ),
